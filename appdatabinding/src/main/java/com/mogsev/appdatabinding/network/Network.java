package com.mogsev.appdatabinding.network;
...
import com.mogsev.appdatabinding.github.ApiGitHub;
...
public final class Network {
    ...
    @NonNull
    public static final ApiGitHub API_GIT_HUB = new Retrofit.Builder()

...
import com.mogsev.githubinfo.adapter.RepositoriesRvAdapter;
import com.mogsev.githubinfo.github.GitHubRepositoriesSearch;
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 0) {
                    ...
                    //Log.i(TAG, "Items: " + firstVisibleItem + "/" + visibleItemCount + "/" + totalItemCount);
